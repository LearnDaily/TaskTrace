...
class TaskStatusTableViewCell: UITableViewCell {
    ...
    class func orderStatusCell(tableView: UITableView) -> TaskStatusTableViewCell {
        var cell = tableView.dequeueReusableCellWithIdentifier(identifier) as? TaskStatusTableViewCell
        if cell == nil {
            cell = TaskStatusTableViewCell(style: UITableViewCellStyle.Default, reuseIdentifier: identifier)
        }
